...
Imagine you are servicing this data to internal analytics users in a production environment. How would you do it? Please answer **ONE** of the following discussion questions about the approach you'd take:

- The review data is ingested into the Data Warehouse from a streaming source at a rate of several million rows per day. How would you structure and run a data pipeline to transform and serve this data to users? What considerations would you make?
...
- Data Scientists and Analysts have changing and emerging needs for the review data. How would you serve this data to our users to maximise trust and understanding in the data, and reduce the need for supporting users with this dataset?
